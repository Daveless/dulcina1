...
let product2 = new Product("Casita de Chocolate", "imgs/producto2.png", 9.99);
let product3 = new Product("Ramo de Fresas", "imgs/producto3.png", 14.99);
let product4 = new Product("Arreglo frutal con Heineken", "imgs/producto4.png", 13.99);
let product5 = new Product("Arreglo en Canasta", "imgs/producto5.png", 26.99);
let product6 = new Product("Regalo para Cumpleaños", "imgs/producto6.png", 16.99);
let product7 = new Product("Cumpleaños de Fresas y Piña", "imgs/producto7.png", 13.99);
let product8 = new Product("Regalo Frutal para Papá", "imgs/producto8.png", 19.99);
let product9 = new Product("Fresas y Masmellos", "imgs/producto9.png", 13.99);
let product10 = new Product("Caja de Corazón con Fresas y Uvillas", "imgs/producto10.png", 12.99);
let product12 = new Product("Regalo de Fresas Cuadrado", "imgs/producto12.png", 21.99);
let product13 = new Product("Marco de Chocolate con Ositos", "imgs/producto13.png", 9.99);
let product14 = new Product("Arreglo Frutal de Corazón especial", "imgs/producto14.png", 13.99);
let product15 = new Product("Canasta de Fresas", "imgs/producto15.png", 13.99);
let product17 = new Product("Pirámide de Fresas", "imgs/producto17.png", 13.99);
let product18 = new Product("Especial de Fresas", "imgs/producto18.png", 13.99);
let product19 = new Product("Arreglo de Fresas para Mamá", "imgs/producto19.png", 16.99);
let product20 = new Product("Arreglo con Rosas para Papá", "imgs/producto20.png", 21.99);
let product22 = new Product("Arreglo Torre de Fresas", "imgs/producto22.png", 16.99);
let product23 = new Product("Arreglo con Lazo", "imgs/producto23.png", 19.99);
let product24 = new Product("Arreglo Enamorados", "imgs/producto24.png", 11.99);
let product25 = new Product("Arreglo 25", "imgs/producto25.jpg", 29.99);
let product26 = new Product("Arreglo 26", "imgs/producto26.jpg", 11.99);
let product27 = new Product("Arreglo 27", "imgs/producto27.jpg", 11.99);
let product28 = new Product("Ajedrez de Chocolate", "imgs/producto28.jpg", 11.99);
let product29 = new Product("Arreglo 29", "imgs/producto29.jpg", 11.99);
